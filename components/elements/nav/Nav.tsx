...
function Nav({ uuid = "" }: NavProps) {
  const pathname = usePathname();
  const isLoginPage = pathname === "/login";
  if (isLoginPage) return null;
  const userPersonalTools = personalTools(uuid);

  return (
    <div className="pt-4 w-full items-center justify-center hidden lg:flex relative z-50">
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
